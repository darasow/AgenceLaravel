...
<head>
    ...
    <title>@yield('titre') | Agence</title>
        ...
        <div class="mx-2 flex flex-wrap items-center justify-between">
            ...
            <div class="hidden md:flex justify-between items-end w-full md:w-auto md:order-1" id="mobile-menu-3">
                <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                    <li>
                        <a href="{{route('listing.index')}}" @class(["md:bg-transparent text-lg  block pl-3 pr-4 py-2 md:p-0 rounded", 'text-blue-700' => str_contains($route, 'propriete.')])
                            aria-current="page">Les Biens</a>
                    </li>
                    <li>
                        <a href="#"
                            class="text-white text-lg hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Services</a>
                    </li>
                </ul>
            </div>
        </div>
